(() => {
          ...
          $2.on(this.bodyScrollable, "scroll", (e) => {
            ...
            requestAnimationFrame(() => {
              ...
              nonStickyHeaderCells.forEach((cell) => {
                $2.style(cell, { transform: `translateX(${-scrollLeft}px)` });
              });
              ...
              stickyHeaderCells.forEach((headerCell) => {
                ...
                const colLeft = parseFloat(headerCell.style.left) || 0;
                ...
                if (~~(bodyCell.offsetLeft - scrollLeft) > colLeft) {
                  ...
                  if (footerCell)
                    footerCell.style.transform = `translateX(${colLeft - footerCell.offsetLeft}px)`;
                }
              });
              this._settingHeaderPosition = false;
            });
  ...
  frappe.views.ReportView = class ReportView extends frappe.views.ListView {
    ...
    setup_paging_area() {
      ...
      this.$paging_area.find(".level-left").after(`<span class="comparison-message text-extra-muted">${message}</span>`);
    }
    setup_sort_selector() {
      var _a, _b, _c;
  ...
  // frappe-html:/home/raven/Workspace/Evaluation2/Evaluation2-erp_python/erp-local/apps/frappe/frappe/public/js/frappe/views/reports/print_grid.html
...
`;
  ...
  // frappe-html:/home/raven/Workspace/Evaluation2/Evaluation2-erp_python/erp-local/apps/frappe/frappe/public/js/frappe/views/reports/print_tree.html
...
`;
  ...
  // frappe-html:/home/raven/Workspace/Evaluation2/Evaluation2-erp_python/erp-local/apps/frappe/frappe/public/js/frappe/ui/group_by/group_by.html
...
//# sourceMappingURL=report.bundle.WGGH3AU3.js.map
