(() => {
  ...
  $(document).ready(function() {
    if (frappe.boot.is_fc_site && frappe.boot.setup_complete === 1 && !frappe.is_mobile() && frappe.user.has_role("System Manager")) {
      frappe.call({
        method: "frappe.integrations.frappe_providers.frappecloud_billing.current_site_info",
        callback: (r) => {
          if (!(r == null ? void 0 : r.message))
            return;
				...
				<div>
					...
					<div>
						...
						<span class="description">
							${isFCUser ? "Please upgrade for uninterrupted services" : "Please contact your system administrator to upgrade your plan."}
						</span>
					</div>
				</div>
				${isFCUser ? `<button type="button"
...
//# sourceMappingURL=billing.bundle.3M2NKQ7F.js.map
